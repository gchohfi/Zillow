...
from .appreciation import assess_appreciation
...
def _close_resource(resource: object | None) -> None:
    """Fecha recursos de rodada sem mascarar o erro original do pipeline."""
    if resource is None:
        return
...
def run(use_mock: bool = False, dry_run: bool = False) -> None:
    ...
    try:
        ...
        _close_resource(signals_cache)
        _close_resource(zoning_cache)
