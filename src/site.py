...
function oppCard(r) {
  ...
  const thesisStats = isDevelopment
    ? '<div class="stat"><div class="l">área bruta</div><div class="v">' +
      ...
      '<div class="stat"><div class="l">líquida estimada</div><div class="v">' +
  ...
  return '<article class="opp ' + r.kind + (isStarred ? " starred" : "") + '">' +
    ...
    "</div>" +
    alert +
    (isDevelopment && r.pending_confirmations
      ? '<div class="small muted"><b>Pendente:</b> ' + esc(r.pending_confirmations) + "</div>"
      : "") +
    reasonChecklist(r) +
